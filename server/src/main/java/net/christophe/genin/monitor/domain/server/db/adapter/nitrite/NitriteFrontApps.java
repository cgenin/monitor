...
public class NitriteFrontApps extends FrontApps {
    private final NitriteIFrontApps port;

    public static class NitriteIFrontApps implements IFrontApps {


        private final NitriteCollection collection;

        public NitriteIFrontApps(NitriteDbs instance) {
    ...
    private NitriteFrontApps(NitriteIFrontApps port, JsonObject packagesJson, String groupId, String artifactId, String version, long lastUpdate) {
