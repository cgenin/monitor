...
public class MysqlFrontApps extends FrontApps {
    ...
    private final MysqlFrontAppsPort port;

    public static class MysqlFrontAppsPort implements FrontAppsPort {
        private final Mysqls mysqls;

        public MysqlFrontAppsPort(Mysqls mysqls) {
            this.mysqls = mysqls;
        }
    ...
    private MysqlFrontApps(MysqlFrontAppsPort port, JsonObject packagesJson, String groupId, String artifactId, String version, long lastUpdate) {
