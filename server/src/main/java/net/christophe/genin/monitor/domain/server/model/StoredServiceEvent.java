...
public abstract class StoredServiceEvent {
    ...
    public static StoredServiceEvent newInstance(JsonObject json, long lastUpdated) {
        return Adapters.get().storedServiceEventHandler().newInstance(json, lastUpdated);
    }
