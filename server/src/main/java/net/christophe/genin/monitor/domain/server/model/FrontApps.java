...
public abstract class FrontApps {
    ...
    public static FrontApps newInstance(JsonObject packagesJson, String groupId, String artifactId, String version) {
        return Adapters.get().frontAppsHandler().newInstance(packagesJson, groupId, artifactId, version);
    }

    public static Observable<FrontApps> findBy(String groupId, String artifactId, String version) {
        return Adapters.get().frontAppsHandler().findBy(groupId, artifactId, version);
    }

    public static Observable<FrontApps> findAll() {
        return Adapters.get().frontAppsHandler().findAll();
    }
