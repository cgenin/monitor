...
public class InitializeDbTest {
    ...
    public void before(TestContext context) {
        ...
        vertx = Vertx.vertx();
        vertx.deployVerticle(InitializeDb.class.getName(), options, context.asyncAssertSuccess());
    }
    ...
    public void should_health_respond_after_starting(TestContext context) {
        ...
        vertx.eventBus().<JsonObject>send(InitializeDb.HEALTH, new JsonObject(), msg -> {
            try {
